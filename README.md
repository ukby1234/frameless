...
|-----------|------------------------------------------|----------|-------------|-------------|
| 0.17.0    | 4.2.0† / 4.1.3† / 4.0.4† / 3.5.8 / 3.4.4 | 2.x      | 3.x         | 2.12 / 2.13 |
...
_† The Spark 4.1.x artifacts (`-spark41`) are published for **Scala 2.13 only** and require **JDK 17+**, since Spark 4 dropped Scala 2.12 and JDK 8/11. The default (unsuffixed) artifacts still target Spark 3.5._
_† The Spark 4.2.x artifacts (`-spark42`) are published for **Scala 2.13 only** and require **JDK 17+**, since Spark 4 dropped Scala 2.12 and JDK 8/11. The default (unsuffixed) artifacts still target Spark 3.5._
